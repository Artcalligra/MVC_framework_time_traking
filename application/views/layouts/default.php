    ...
    <header>
        <div class = "container">
            <div class = "header-items">
                ...
                <div class = "header-item header-items__time-popup" id = "itemPopupTime">
                    <span>Длительность рабочего дня: </span>
                    <div id="timer"></div><br>
                    <input id="button_start" type="button" value="Start" onclick="get_time()" />
                    <input id="button_pause" type="button" value="Pause" onclick="pause_time()" />
                    <input id="button_stop" type="button" value="Stop" onclick="stop_time()" />

                </div>
                <div class = "header-item header-items__user" id = "openPopupSettings"><p><?php echo ($user['user_name']); ?><p></div>
                <div class = "header-item header-items__user-popup" id = "itemPopupSettings"><p>моя страница, выйти</p></div>
            </div>
        </div>
    </header>
    <main>
